...
public class NetworkUtils {
     ...
     * <li>{@link NetworkType#_4g     } </li>
     * <li>{@link NetworkType#_3g     } </li>
     * <li>{@link NetworkType#_2g     } </li>
     * <li>{@link NetworkType#unknown} </li>
     * <li>{@link NetworkType#no     } </li>
     * </ul>
     */
    public static NetworkType getNetworkType() {
        NetworkType netType = NetworkType.no;
        NetworkInfo info = getActiveNetworkInfo();
            ...
            if (info.getType() == ConnectivityManager.TYPE_WIFI) {
                ...
                switch (info.getSubtype()) {
                    ...
                    case TelephonyManager.NETWORK_TYPE_HSPAP:
                        netType = NetworkType._3g;
                        break;

                    case NETWORK_TYPE_IWLAN:
                    case TelephonyManager.NETWORK_TYPE_LTE:
                        netType = NetworkType._4g;
                        break;
                    default:
