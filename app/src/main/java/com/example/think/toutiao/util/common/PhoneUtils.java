...
public class PhoneUtils {
    ...
    public static void getContactNum() {
        ...
        intent.setItemType("vnd.android.cursor.dir/phone_v2");
    ...
    public static void getAllSMS() {
        ...
        // selectionArgs : 查询条件的参数
        // sortOrder : 排序
        Cursor cursor = resolver.query(uri, new String[]{"address", "date", "itemType", "body"}, null, null, null);
        // 设置最大进度
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                xmlSerializer.startTag(null, "itemType");
                String type = cursor.getString(2);
                xmlSerializer.text(type);
                xmlSerializer.endTag(null, "itemType");
                xmlSerializer.startTag(null, "body");
                String body = cursor.getString(3);
                xmlSerializer.text(body);
                xmlSerializer.endTag(null, "body");
                xmlSerializer.endTag(null, "sms");
                System.out.println("address:" + address + "   date:" + date + "  itemType:" + type + "  body:" + body);
            }
